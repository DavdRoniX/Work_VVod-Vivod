...
namespace TurboC_Output_Input
{
    ...
    public partial class Form3 : Form
    {
        List<Question> questions = new List<Question>()
        {
            ...
            new Question("Нужно ли иметь права root для вызова ioperm() в стандартном способе?",new string[]{ "да", "нет", "зависит от ситуации"},"да"),
            ...
            new Question("Нужно ли освобождать порты при помощи ioperm(…, 0) в стандартном\nспособе?", new string[]{"да", "нет"}, "да"),
            new Question("Какая функция выводит байт в порт?", new string[]{"inb(port)", "outb(value, port)", "ioperm(from, num, turn_on)", "outw(value, x)"}, "outb(value, port)"),
            new Question("Сколько нужно времени на выполнение для функции работающей с\nпортамив стандартном способе?", new string[]{"секунда", "5 сек", "микросекунда"}, "микросекунда"),
            new Question("Для альтернативного способа нужна оптимизация?", new string[]{"да", "нет"}, "да"),
            new Question("Альтернативный способ быстрее стандартного?", new string[]{"да", "нет"}, "да"),
            new Question("Какая нужна отпимизация в стандартном способе?", new string[]{"gcc", "msvc", "clang", "icc"}, "gcc"),
            new Question("Для считывания байта из порта нужно вызвать функцию…", new string[]{"inb(port)", "outb(value, port)", "ioperm(from, num, turn_on)", "outw(value, x)"}, "inb(port)"),
            new Question("Оперативная память является периферийным устройством?", new string[]{"да", "нет"}, "нет"),
            new Question("Сколько регистров имеет контроллер параллельного интерфейса?", new string[]{"2", "3", "4", "5"}, "3"),
            new Question("Кем осуществляется адресация портов?", new string[] {"видеокарта", "ЦП", "ОЗУ"}, "ЦП"),
            new Question("Входит ли звуковых карт в адресное пространство портов?", new string[]{"да", "нет"}, "да"),
            new Question("Может ли одно периферийное устройство использовать несколько\nпортов ввода/вывода?", new string[]{"да", "нет"}, "да")
        };
